...
import './BoxShadowSingle.css'
import * as Util from '../../../../globals/Util'
import { ChromePicker } from 'react-color';

class BoxShadowSingle extends Component {
	state = {
			...
			<div className="box-shadow__item">
				...
				<div className="range__item-slider">
					<InputRange
						...
						formatLabel={(value) => {return value + 'px'}}
						minValue={this.props.minValue}
						onChange={(value) => this.props.onRangeChange(value, 'spread')}
						value={this.props.value.spread}/>
					<div className="range__item-input">
						<input className='range__item-label-input input'
							   type={'tel'}
							   value={this.props.value.spread}
							   onChange={(event) => {
								   return this.props.onRangeChange(Util.checkNumberInput(event, this.props.maxValue, this.props.minValue, this.props.value.spread), 'spread')
							   }}/>
						<span>px</span>
					</div>
					<div className="range__item-label">
				...
				<div className="color-control cf">
					<div className="box-checkbox">
						<label>
							Inset Shadow?
							<input type="checkbox" onChange={(event) => this.props.onRangeChange(event.target.checked, 'type')}/>
						</label>
					</div>
...
export default connect(mapStateToProps)(BoxShadowSingle)